...
public class TelaBilhete {
	...
	private void initialize() {
		...
		button_1.setToolTipText("remover o telefone");
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					int escolha = JOptionPane.showOptionDialog(null, "Confirma exclus�o do telefone "+numero, "Alerta",
							JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[1]);
					if(escolha == 0) {
						Fachada.apagarTelefone(numero);
		...
		button.setBounds(125, 11, 112, 23);
		...
		button_3.setToolTipText("alterar o numero do telefone");
	...
	public void listagem () {
		try{
			List<Telefone> lista = Fachada.listarTelefones();
			...
			for(Telefone t : lista) {
				if(t.getPessoa() != null)
					model.addRow(new Object[]{  t.getNumero(), t.getPessoa().getNome() });
				else
					model.addRow(new Object[]{ t.getNumero(),  "desconhecido"});
			}
